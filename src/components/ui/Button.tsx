...
const variants: Record<Variant, string> = {
  ...
  // Secondary CTA — premium green gradient, lighter at rest and darker on hover
  secondary:
    "bg-green-gradient text-white hover:bg-green-gradient-dark hover:-translate-y-0.5 shadow-soft",
